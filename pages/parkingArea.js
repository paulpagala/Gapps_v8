...
// let iterateParkingSlots = (typeof (parkingSlotNames[indexOfParking]) !== "undefined"?(parkingAreaFloor[indexOfParking].map((parkingfloor, indexParkingFloor) =>
...
// {typeof (parkingSlotNames[indexOfParking][indexParkingFloor]) !== "undefined" ? parkingSlotNames[indexOfParking][indexParkingFloor].map((row, index) => (
